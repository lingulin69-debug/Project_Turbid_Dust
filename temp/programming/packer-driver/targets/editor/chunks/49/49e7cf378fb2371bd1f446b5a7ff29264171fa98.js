    ...
    execute: function () {
      ...
      _export("LoginController", LoginController = (_dec = ccclass('LoginController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(EditBox), _dec6 = property(EditBox), _dec7 = property(Button), _dec8 = property(Label), _dec9 = property(EditBox), _dec10 = property(EditBox), _dec11 = property(Button), _dec12 = property(Label), _dec13 = property(Material), _dec14 = property(Material), _dec(_class = (_class2 = class LoginController extends Component {
        ...
        async onLoginPressed() {
          ...
          const ocName = (_this$ocNameInput$str = (_this$ocNameInput = this.ocNameInput) == null ? void 0 : _this$ocNameInput.string.trim()) != null ? _this$ocNameInput$str : '';
          const password = (_this$passwordInput$s = (_this$passwordInput = this.passwordInput) == null ? void 0 : _this$passwordInput.string.trim()) != null ? _this$passwordInput$s : '';
          ...
          try {
            const data = await (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
        ...
        async onConfirmResetPressed() {
          var _this$newPasswordInpu, _this$newPasswordInpu2, _this$confirmPassword, _this$confirmPassword2;

          const newPwd = (_this$newPasswordInpu = (_this$newPasswordInpu2 = this.newPasswordInput) == null ? void 0 : _this$newPasswordInpu2.string.trim()) != null ? _this$newPasswordInpu : '';
          const confirmPwd = (_this$confirmPassword = (_this$confirmPassword2 = this.confirmPasswordInput) == null ? void 0 : _this$confirmPassword2.string.trim()) != null ? _this$confirmPassword : '';
          ...
          try {
            await (_crd && DataManager === void 0 ? (_reportPossibleCrUseOfDataManager({
              error: Error()
            }), DataManager) : DataManager).updatePassword(newPwd);
            console.log('[LoginController] 密碼更新成功，完成登入流程');

            if (this._pendingLoginData) {
              this._persistSession(this._pendingLoginData.user_id, this._pendingLoginData.token);
