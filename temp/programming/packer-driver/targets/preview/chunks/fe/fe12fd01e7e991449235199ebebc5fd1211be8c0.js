    ...
    execute: function () {
      ...
      _export("WhiteCrowCard", WhiteCrowCard = (_dec = ccclass('WhiteCrowCard'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property([Node]), _dec11 = property(Material), _dec12 = property(Material), _dec(_class = (_class2 = class WhiteCrowCard extends Component {
        ...
        _applyTheme() {
          ...
          var c = WC_COLORS[this._faction];
          var th = (_crd && getPageTheme === void 0 ? (_reportPossibleCrUseOfgetPageTheme({
            error: Error()
          ...
          var closeIcon = (_this$closeButtonNode = this.closeButtonNode) == null ? void 0 : _this$closeButtonNode.getComponentInChildren(Sprite);
        ...
        _updateHpLabel(hp) {
          ...
          var isLow = player ? hp < player.max_hp / 2 : false;
        ...
        checkRelicPoem(collectedRelics) {
          var collected = new Set(collectedRelics);
          var matched = [...RELIC_POEM_TRIGGER].filter(id => collected.has(id));
          ...
          if (matched.length === RELIC_POEM_TRIGGER.size) {
            ...
            var remaining = RELIC_POEM_TRIGGER.size - matched.length;
