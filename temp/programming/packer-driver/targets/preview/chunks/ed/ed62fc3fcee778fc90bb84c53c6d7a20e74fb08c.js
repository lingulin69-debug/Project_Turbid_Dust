  ...
  return {
    ...
    execute: function () {
      ...
      _export("DiceResultOverlay", DiceResultOverlay = (_dec = ccclass('DiceResultOverlay'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Node), _dec(_class = (_class2 = class DiceResultOverlay extends Component {
         ...
         */
        rollDice(targetValue, hasAdvantage) {
          if (hasAdvantage === void 0) {
            hasAdvantage = false;
          }
          ...
          var finalNumber = hasAdvantage ? Math.max(this._d20(), this._d20()) : this._d20();
          var isSuccess = finalNumber >= targetValue; // 啟動跳動動畫
